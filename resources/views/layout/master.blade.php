    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="index.html"><img src={{ asset('template/images/logo.svg') }}
                        alt="logo" /></a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/logReg"> Login </a>
                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="d-sm-flex justify-content-between">
                                                ...
                                                <div>
                                                    <button type="button"
                                                        class="btn btn-sm btn-light mr-2">Day</button>
                                                    <button type="button"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <img class="img-sm rounded-circle mb-md-0 mr-2"
                                                                src={{ asset('template/images/faces/face34.png') }}
                                                                alt="profile image">
                                                            <div>
                                                                <div> Company</div>
                                                                <div class="font-weight-bold  mt-1">volkswagen</div>
